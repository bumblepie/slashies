...
//!
//! Slash helper helps to reduce the boiler plate code needed to create slash commands for a Discord bot. It is built on top of [`Serenity`].
...
//! [`Serenity`]: serenity
//!
//! With slash helper, you can create a slash command in four easy steps:
